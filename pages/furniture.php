...
<head>
    ...
    <!-- Your custom styles -->
    <link rel="stylesheet" href="../style/furniturestyle.css">
...
<body>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <video autoplay muted loop class="w-100">
                        <source src="../img/furniturecaro.mp4" type="video/mp4">
    ...
    <div class="header">
        <img src="../img/FurniturePic.png" alt="Header Image" styles="text-align: center;">
        <h1 styles="text-align: center;">Furniture</h1>
    </div>
...
// Fetch furniture products with pagination
$sql = "SELECT * FROM products WHERE item_type='furniture' LIMIT ? OFFSET ?";
$stmt = $conn->prepare($sql);
...
foreach ($paragraphs as $paragraph) {
    ...
    echo "<p class='text-center'>No products found in the 'furniture' category.</p>";
}

// Calculate total number of pages
$sql = "SELECT COUNT(*) AS total FROM products WHERE item_type='furniture'";
